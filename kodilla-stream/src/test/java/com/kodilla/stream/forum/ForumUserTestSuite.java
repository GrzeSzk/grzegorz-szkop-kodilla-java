...
public class ForumUserTestSuite {
    ...
    void testGetLocationsOfFriends(){
        //Given
        //Create users
        com.kodilla.stream.forum.ForumUser user1 = new com.kodilla.stream.forum.ForumUser("alan01", "Alan Kosovsky", "Washington");
        com.kodilla.stream.forum.ForumUser user2 = new com.kodilla.stream.forum.ForumUser("ethanreard", "Ethan Reard", "Miami");
        com.kodilla.stream.forum.ForumUser user3 = new com.kodilla.stream.forum.ForumUser("eRiK", "Erik Hull", "Key West");
        com.kodilla.stream.forum.ForumUser user4 = new com.kodilla.stream.forum.ForumUser("booth", "Mya Booth", "Washington");
        com.kodilla.stream.forum.ForumUser user5 = new com.kodilla.stream.forum.ForumUser("nicole1987", "Nicole Lee", "Orlando");
        com.kodilla.stream.forum.ForumUser user6 = new com.kodilla.stream.forum.ForumUser("nobody", "Briana Williams", "Miami");
        com.kodilla.stream.forum.ForumUser user7 = new com.kodilla.stream.forum.ForumUser("bigmac", "Robert Macdonald", "Washington");
        com.kodilla.stream.forum.ForumUser user8 = new com.kodilla.stream.forum.ForumUser("thebigone", "Clay Small", "Orlando");
        com.kodilla.stream.forum.ForumUser user9 = new com.kodilla.stream.forum.ForumUser("user121212", "Marisa Frank", "Washington");
        com.kodilla.stream.forum.ForumUser user10 = new com.kodilla.stream.forum.ForumUser("lawyer", "Lexie John", "Miami");
